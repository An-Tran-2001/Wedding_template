...
document.querySelector('.messenger').addEventListener('click', function () {
    document.querySelector('.tbody').style.display = 'flex';
    document.querySelector('.tbody').classList.toggle('active');
});

document.getElementById('close-mess').addEventListener('click', function () {
